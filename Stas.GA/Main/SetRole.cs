            ...
            case Role.Master:
                ...
                switch (mname) {
                    ...
                    default: {
                            ...
                            ui.AddToLog("SetRole err: You must specify the IP address through\n" +
                                " which the bots will connect to you", MessType.Critical);
                            ui.AddToLog("Edit setting =>master_IP", MessType.Critical);
                            break;
                        }
                }
                break;
